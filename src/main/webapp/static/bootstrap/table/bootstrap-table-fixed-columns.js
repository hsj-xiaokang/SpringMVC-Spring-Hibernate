(function($) {
    ...
    BootstrapTable.prototype.initFixedColumns = function() {
        this.$fixedBody = $(['<div class="fixed-table-column" style="position: absolute; background-color: #fff; border-right:1px solid #ddd;">', '<table>', '<thead></thead>', '<tbody></tbody>', '</table>', '</div>'].join(''));
    ...
    BootstrapTable.prototype.fitHeaderColumns = function() {
        ...
        this.$body.find('tr:first-child:not(.no-records-found) > *').each(function(i) {
            ...
            that.$fixedBody.find('thead th[data-field="' + visibleFields[index] + '"]').find('.fht-cell').width($this.innerWidth() - 1);
